        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-20">
                ...
                <div class="pb-20">
                    ...
                    <!-- Form -->
                    <?php echo form_open('pengirim-hutang/tambah'); ?>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nama Pengirim</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control <?= (form_error('nama') ? 'form-control-danger' : null) ?>" name="nama" type="text" placeholder="Nama pengirim.." value="<?= set_value('nama') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control <?= (form_error('hp') ? 'form-control-danger' : null) ?>" name="hp" placeholder="Cth:089988887777" type="text" value="<?= set_value('hp') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control <?= (form_error('alamat') ? 'form-control-danger' : null) ?>" name="alamat" placeholder="Alamat.." type="text" value="<?= set_value('alamat') ?>">
