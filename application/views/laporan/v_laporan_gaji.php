                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="<?= base_url('laporan-gaji/cetak-perbulan'); ?>" target="_blank" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="<?= base_url('laporan-gaji/cetak-perperiode'); ?>" target="_blank" method="post">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-6">
