                ...
                <div class="pb-20">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control <?= (form_error('nama') ? 'form-control-danger' : null) ?>" name="nama" type="text" placeholder="Nama lengkap.." value="<?= set_value('nama') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control <?= (form_error('username') ? 'form-control-danger' : null) ?>" name="username" placeholder="Username..." type="text" value="<?= set_value('username') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select name="role" class="form-control <?= (form_error('role') ? 'form-control-danger' : null) ?>">
                                ...
                                <option value="2">Staff Kantor</option>
                                <option value="3">Staff Lapangan</option>
                            </select>
