...
class PenjualanController extends CI_Controller
{
    ...
    public function tambah()
    {
        ...
        // tombol simpan ditekan dan lolos validasi
        else {
            $noKwitansi = $this->getNoKwitansi();
    ...
    public function edit($id)
    {
        ...
        // tombol update ditekan
            ...
            // variabel hasil hitungan($berat, $biaya, $biayaSMU, $biayaGudang, $totalOperasional, $biayaTotal);
            ...
            if ($this->Penjualan->updatePenjualan($idPenjualan, $penerima, $kotaTujuan, $airlines, $noPenerbangan, $noSMU, $berat, $koli, $customHarga, $biaya, $biayaSMU, $adminSMU, $biayaOperasional, $totalOperasional, $isi, $catatan, $hargaGudang, $adminGudang, $biayaGudang, $biayaTambahan, $biayaTotal, $jenisPembayaran)) {
